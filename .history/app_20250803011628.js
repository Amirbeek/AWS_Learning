document.addEventListener('DOMContentLoaded', function() {
    ...
    const API_ENDPOINT = 'https://refoultaf1.execute-api.us-east-1.amazonaws.com/dev/SumCalculatorAPI
'; // Example: https://5nur6rhsjb.execute-api.us-east-1.amazonaws.com/dev
